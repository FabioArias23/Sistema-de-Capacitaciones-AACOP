...
Generated by Repomix on: 2025-11-27 15:16:20
...
; 🔥 Configuración de procesos optimizada para Render (512MB-1GB RAM)
pm = dynamic
pm.max_children = 10
pm.start_servers = 2
...
; 🔥 CRÍTICO: No limpiar variables de entorno
clear_env = no
...
; 🔥 NUEVO: Configuraciones PHP importantes para producción
...
; 🔥 NUEVO: Optimizaciones de OPcache para Laravel
...
startretries=3
priority=2
# Nginx debe iniciar después de PHP-FPM
depends_on=php-fpm
```
